...
counter = 0;
while(counter<1)
counter = 0; %run the optimization until a controller is found (wrt desired feasibility criteria)

%optimization parameters
eps = 10^-3; %epsilon
num_iter = 1000; %number of max iterations in a single run of the optimization
...
%stop the algorithm if the desired feasibility criteria is met
